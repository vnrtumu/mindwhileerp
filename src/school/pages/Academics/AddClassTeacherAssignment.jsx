...
const AddClassTeacherAssignment = () => {
    const { classes, sections, addAssignment } = useContext(AcademicsContext);
            ...
            <div className="p-8 max-w-2xl mx-auto">
                <div className="premium-form-card overflow-hidden">
                    <div className="p-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                        ...
                        <h2 className="text-xl font-black text-gray-800 tracking-tight">Assign Teacher</h2>
                    </div>
...
export default AddClassTeacherAssignment;
