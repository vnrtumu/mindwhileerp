...
const DUMMY_USERS = [
    ...
    { id: 3, name: "Robert Brown", role: "Guardian", phone: "john.doe@example.com" },
    { id: 4, name: "Emily White", role: "Teacher", department: "Science" },
    { id: 5, name: "Michael Green", role: "Admin", department: "Management" },
    { id: 6, name: "William Davis", role: "Teacher", department: "Mathematics" },
    { id: 7, name: "Jessica Taylor", role: "Teacher", department: "English" }
];
...
const SendEmail = () => {
    ...
    const { emailTemplates } = useCommunication() || { emailTemplates: [] }; // Fallback for safety
    ...
    return (
        <StudentPageContainer title="Send Email" description="Compose and send bulk emails to students, staff, and guardians.">
                            ...
                            <div className="sms-grid">
                                ...
                                <div className="sms-form-column">
                                    <div className="sms-form-section">
                                        <label className="sms-label">Email Template</label>
                                        <select
                                    ...
                                    <div className="sms-form-section">
                                        <label className="sms-label">Attachment</label>
                                        <div className="file-drop-area" onClick={() => document.getElementById('file_upload').click()}>
                                            <Paperclip className="w-5 h-5" />
                                            {formData.attachment ? formData.attachment.name : "Drag and drop a file here or click"}
                                            <input
                                                type="file"
                                                id="file_upload"
                                                style={{ display: 'none' }}
