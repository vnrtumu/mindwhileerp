...
import {
    Plus, Search, Trash2, Check, Copy, PenSquare, X, Eye, MessageCircle
} from 'lucide-react';
import './SendSMS.css';
...
const WhatsappTemplate = () => {
    const { whatsappTemplates, addWhatsappTemplate, updateWhatsappTemplate, deleteWhatsappTemplate } = useCommunication();
    ...
    const handleSave = () => {
        ...
        if (editingTemplate) { updateWhatsappTemplate(editingTemplate.id, formData); }
        else { addWhatsappTemplate(formData); }
        setIsModalOpen(false);
    };

    const handleDelete = (id) => {
        if (confirm('Are you sure you want to delete this template?')) { deleteWhatsappTemplate(id); }
    };
    ...
    return (
        <div className="email-template-page">
            <StudentPageContainer title="WhatsApp Template List" description="Manage WhatsApp templates for quick communication.">
                <div className="sms-container" style={{ padding: 0, background: 'transparent' }}>
                    <div className="template-card">
                        <div className="template-header">
                            ...
                            <button className="btn-template-add" onClick={() => handleOpenModal()} style={{ background: '#16a34a' }}>
                                <Plus className="w-5 h-5 stroke-[2.5]" /> Add WhatsApp Template
                            </button>
                        </div>
                                        ...
                                        <tr key={template.id}>
                                            <td style={{ fontWeight: 600, color: '#334155' }}>
                                                <div className="flex items-center gap-3">
                                                    <div className="w-9 h-9 rounded-full bg-green-50 border border-green-100 text-green-600 flex items-center justify-center shrink-0 shadow-sm">
                                        ...
                                        <tr>
                                            <td colSpan="3" style={{ padding: '80px 0', textAlign: 'center' }}>
                                                <div className="flex flex-col items-center justify-center text-slate-400 gap-4">
                                                    ...
                                                    <p className="font-medium text-slate-500 text-lg">No WhatsApp templates found</p>
                                                    <button onClick={() => handleOpenModal()} className="text-green-600 hover:text-green-700 font-medium text-sm flex items-center gap-1">
                    ...
                    <div className="tpl-modal" onClick={(e) => e.stopPropagation()}>
                        <div className="tpl-header">
                            <div className="tpl-header-left">
                                <div className="tpl-header-icon wa">
                                    <MessageCircle size={18} />
                                </div>
                                <div>
                                    <div className="tpl-header-title">Template Preview</div>
                                    <div className="tpl-header-sub">WhatsApp Template</div>
                                </div>
                            </div>
                        ...
                        <div className="tpl-body">
                            <div className="tpl-field">
                                ...
                                <div className="tpl-preview-meta">
                                    <span className="tpl-preview-badge wa">WhatsApp</span>
                            ...
                            <div className="tpl-field">
                                ...
                                <div className="tpl-preview-box" style={{ background: '#f0fdf4', borderColor: '#bbf7d0' }}>
                        ...
                        <div className="tpl-footer">
                            ...
                            <button className="tpl-btn-edit" style={{ background: '#16a34a' }} onClick={() => { setViewTemplate(null); handleOpenModal(viewTemplate); }}>
                    ...
                    <div className="tpl-modal" onClick={(e) => e.stopPropagation()}>
                        <div className="tpl-header">
                            <div className="tpl-header-left">
                                ...
                                <div>
                                    <div className="tpl-header-title">{editingTemplate ? 'Edit WhatsApp Template' : 'Add WhatsApp Template'}</div>
                        ...
                        <div className="tpl-body">
                            <div className="tpl-field">
                                ...
                                <input type="text" className="tpl-input wa"
                            ...
                            <div className="tpl-field">
                                <label className="tpl-label">
                                    WhatsApp Message <span className="required-star">*</span>
                                    <span className="tpl-label-badge">{formData.message.length} chars</span>
                                </label>
                                <textarea className="tpl-textarea wa"
                            ...
                            <div className="tpl-vars">
                                ...
                                <div className="tpl-vars-chips">
                                    {['[NAME]', '[DATE]', '[CLASS]', '[ROLL_NO]', '[ADMISSION_NO]'].map(tag => (
                                        <button key={tag} type="button" className="tpl-chip wa" onClick={() => insertPlaceholder(tag)}>{tag}</button>
                                    ))}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="tpl-footer">
                            ...
                            <button className="tpl-btn-save wa" onClick={handleSave}>
                                <Check size={15} />
