    ...
    <div className="payroll-page">
      <div className="container">
        <div className="page-header">
          <div className="page-title">
            <div className="back-button-wrapper">
              ...
              <div>
                <h4>Leave Types</h4>
                <nav className="breadcrumb"><span>Human Resource</span> / <span className="current">Leave Types</span></nav>
              </div>
            </div>
          </div>
        ...
        <div className="card table-card soft-card">
          <div style={{padding:20}}>Leave Types placeholder — manage leave types here.</div>
        </div>
      </div>
    </div>
  );
