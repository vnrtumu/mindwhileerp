...
import { ArrowUp, ArrowDown, ChevronsUpDown, Trash2, Plus } from 'lucide-react';
import {
    Select,
    SelectContent,
    SelectItem,
...
interface PlansTableProps<T> {
    data?: T[];
}

export const PlansTable = <T extends Record<string, unknown>>({
    data = [],
}: PlansTableProps<T>) => {
