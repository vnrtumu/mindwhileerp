        ...
        items: [
            {
                ...
                icon: IconCash,
                subItems: [
                    { title: 'Collect Fees', path: '/finance/collect-fees' },
                    { title: 'Search Due Fees', path: '/finance/search-due-fees' },
                    { title: 'All Transactions', path: '/finance/all-transactions' },
                    { title: 'Online Transactions', path: '/finance/online-transactions' },
                    { title: 'Fees Carry Forward', path: '/finance/fees-carry-forward' },
                    { title: 'Assign Fees', path: '/finance/assign-fees' },
                    { title: 'Fee Groups', path: '/finance/fee-groups' },
                    { title: 'Fees Discount', path: '/finance/fees-discount' },
                    { title: 'Fee Types', path: '/finance/fee-types' },
                    { title: 'Fee Permissions', path: '/finance/fee-permissions' }
                ]
            },
            {
                title: 'Accounts',
            ...
            },
            {
                ...
                icon: IconUser,
                subItems: [
                    { title: 'Student List', path: '/student-info/student-list' },
                    { title: 'Student Attendance', path: '/student-info/student-attendance' },
                    { title: 'Behavior Records', path: '/student-info/behavior-records' },
                    { title: 'Student Categories', path: '/student-info/student-categories' },
                    { title: 'Disabled Students', path: '/student-info/disabled-students' }
                ]
            },
            {
                title: 'Academics',
                ...
                subItems: [
                    ...
                    { title: 'Assign Subjects', path: '/academics/assign-subjects' },
                    { title: 'Assign Class Teacher', path: '/academics/assign-class-teacher' },
                    { title: 'Manage Periods', path: '/academics/manage-periods' },
                    { title: 'Class Timetable', path: '/academics/class-timetable' },
                    { title: 'Promote Students', path: '/academics/promote-students' },
                    { title: 'Homework', path: '/academics/homework' }
                ]
            },
            {
                title: 'Front Office',
